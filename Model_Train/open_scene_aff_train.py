...
def train(**kwargs):
    ...
    train_data = DataLoader_AffModel(mode="train", data_dir="Model_Train/Data/open_scene/train")
    val_data = DataLoader_AffModel(mode="val", data_dir="Model_Train/Data/open_scene/val")
    ...
    for epoch in range(opt.max_epoch):
        ...
        if (epoch + 1) % opt.print_freq == 0:
            if not os.path.exists("Model_Train/Model_Checkpoints/open_scene"):
                os.makedirs("Model_Train/Model_Checkpoints/open_scene")
            torch.save(
                model.state_dict(),
                f"Model_Train/Model_Checkpoints/open_scene/open_scene_{epoch+1}.pth",
            )
