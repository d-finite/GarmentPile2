...
class Config:
    def __init__(self):
        ...
        # ------------Table Config------------ #
        self.table_position = [0.0, 2.5, 0.0]  # sequence:"XYZ"
        self.table_orientation = [0.0, 0.0, 0.0]
        self.table_prim_path = "/World/Table"
        self.table_usd_path = self.path + "/Assets/Scene/SquareTable.usd"
        self.table_scale = [0.02, 0.02, 0.02]
        
        self.temp_wall1_position = [0.45, 2.5, 3.0]
        self.temp_wall2_position = [0.0, 2.85, 3.0]
        self.temp_wall3_position = [ -0.45, 2.5, 3.0]
        self.temp_wall4_position = [0.0, 2.05, 3.0]
        self.temp_ceiling_position = [0.0, 2.5, 15.0]
        ...
        # ------------Top Camera Config------------ #
        self.top_camera_position = [0.0, 2.5, 3.7]
