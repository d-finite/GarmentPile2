...
class Config:
    def __init__(self):
        ...
        # ------------Franka Robot Config------------ #
        self.robot_position = [0.0, 1.76, 0.7]  # sequence:"XYZ"
        self.robot_orientation = [
            0.0,
            0.0,
            90.0,
        ]  # sequence:"XYZ", input degrees, e.g.[0.0, 0.0, 90.0]
        self.ee_position = [1.6942e-12, 1.5380e+00, 1.0460e+00]  # sequence:"XYZ"
        self.ee_orientation = [
            180.0,
            0.0,
            0.0,
        ]  # sequence:"XYZ", input degrees, e.g.[0.0, 0.0, 90.0]
        self.grp_position = [ -0.0154, 1.8806, 0.6371]
        self.grp_orientation = [ -0.2699, 0.6331, 0.6698, 0.2788]
        ...
        self.basket_sx = 0.37
        self.basket_sy = 0.283
        self.basket_sz = 0.155

        self.basket_thick = 0.03
        self.basket_color = np.array ([203, 177, 147], dtype = float) / 255.0

        self.basket_position = [0.0, 2.347, 0.7]
        self.basket_orientation = [0.0, 0.0, 90.0]
        self.basket_prim_path = "/World/Basket"

        self.temp_wall1_position = [0.367, 2.347, 4.5]
        self.temp_wall2_position = [0.0, 2.627, 4.5]
        self.temp_ceiling_position = [0.0, 2.347, 9.0 + 0.862]
        ...
        # ------------Collection Basket Config------------ #
        self.collection_basket_position = [0.0, 1.66, 0.7]
        self.collection_basket_orientation = [0.0, 0.0, 90.0]
        self.collection_basket_scale = [0.4, 0.4, 0.4]
        self.collection_basket_prim_path = "/World/Collection_Basket"
        # basket_Usd_Path(no need to change)
        self.collection_basket_usd_path = self.path + "/Assets/Basket/basket.usd"


        # ------------Top Camera Config------------ #
        self.top_camera_position = [0.0, 2.3565, 2.82]
        self.top_camera_resolution = [640, 640]
        self.top_camera_orientation = [0, 0, 0]


        # ------------Extra Camera Config------------ #
        self.extra_camera_position = [0.0, 4.5, 3.35]
        self.extra_camera_resolution = [640, 640]
        self.extra_camera_orientation = [45, 0, 180]


        # ------------Recording Camera Config------------ #
        self.recording_camera_position = [0.0, -2.2, 5.0]
        self.recording_camera_orientation = [46, 0, 0]
        ...
        self.clothpath = {
            ...
            "cloth135": self.path
            + "/Assets/Garment/Dress/Short_LongSleeve/DLLS_Dress054_1/DLLS_Dress054_1_obj.usd",
            "cloth136": self.path + "/Assets/Garment/Hat/HA_Hat012/HA_Hat012_obj.usd",
        }
        
        self.clothpath_spec_style = {
            # ----------- target ------------
            "cloth0": self.path
            + "/Assets/Garment/Glove/GL_Gloves036/GL_Gloves036_obj.usd",  # white gloves
            # ----------- dress ------------
            "cloth1": self.path
            + "/Assets/Garment/Dress/Long_LongSleeve/DLLS_Dress333/DLLS_Dress333_obj.usd",  # blue dress
            "cloth2": self.path
            + "/Assets/Garment/Dress/Long_ShortSleeve/DLSS_Dress172/DLSS_Dress172_obj.usd", # red dress
            "cloth3": self.path
            + "/Assets/Garment/Dress/Short_LongSleeve/DSLS_Dress207/DSLS_Dress207_obj.usd", # pink dress
            "cloth4": self.path
            + "/Assets/Garment/Dress/Short_LongSleeve/DSLS_Dress415/DSLS_Dress415_obj.usd", # black dress
            "cloth5": self.path
            + "/Assets/Garment/Dress/Short_NoSleeve/DSNS_Dress151/DSNS_Dress151_obj.usd",   # white dress
            # ----------- tops ------------
            "cloth6": self.path
            + "/Assets/Garment/Tops/Collar_Lsleeve_FrontClose/TCLC_018/TCLC_018_obj.usd",   # black tops
            "cloth7": self.path
            + "/Assets/Garment/Tops/Collar_Lsleeve_FrontClose/TCLC_082/TCLC_082_obj.usd",   # white tops
            "cloth8": self.path
            + "/Assets/Garment/Tops/Collar_Lsleeve_FrontClose/TCLC_Top107/TCLC_Top107_obj.usd", # red tops
            "cloth9": self.path
            + "/Assets/Garment/Tops/Collar_Lsleeve_FrontClose/TCLC_Top583/TCLC_Top583_obj.usd", # blue tops
            "cloth10": self.path
            + "/Assets/Garment/Tops/Collar_Lsleeve_FrontOpen/TCLO_Normal_Model_057/TCLO_Normal_Model_057_obj.usd",  # green tops
            "cloth11": self.path
            + "/Assets/Garment/Tops/Hooded_Lsleeve_FrontOpen/THLO_Hoody003/THLO_Hoody003_obj.usd",  # purple tops
            "cloth12": self.path
            + "/Assets/Garment/Tops/Hooded_Lsleeve_FrontOpen/THLO_Jacket065/THLO_Jacket065_obj.usd",    # green tops
            "cloth13": self.path
            + "/Assets/Garment/Tops/Hooded_Lsleeve_FrontOpen/THLO_Jacket107/THLO_Jacket107_obj.usd",    # cyan tops
            # ----------- hat ------------
            "cloth14": self.path
            + "/Assets/Garment/Hat/HA_Hat011/HA_Hat011_obj.usd",    # white hat
            "cloth15": self.path
            + "/Assets/Garment/Hat/HA_Hat015/HA_Hat015_obj.usd",    # red hat
            "cloth16": self.path
            + "/Assets/Garment/Hat/HA_Hat018/HA_Hat018_obj.usd",     # brown hat
            "cloth17": self.path
            + "/Assets/Garment/Hat/HA_Hat049/HA_Hat049_obj.usd",    # green hat
            "cloth18": self.path
            + "/Assets/Garment/Hat/HA_hat104/HA_hat104_obj.usd",    # pink hat
            "cloth19": self.path
            + "/Assets/Garment/Hat/HA_Hat023/HA_Hat023_obj.usd",    # black hat
             # ----------- trousers ------------
            "cloth20": self.path
            + "/Assets/Garment/Trousers/Short/PS_M1_040/PS_M1_040_obj.usd",  # red trousers
            "cloth21": self.path
            + "/Assets/Garment/Trousers/Long/PL_075/PL_075_obj.usd",    # black trousers
            "cloth22": self.path
            + "/Assets/Garment/Trousers/Long/PL_M1_007/PL_M1_007_obj.usd",      # white trousers
        }

        self.clothpath_spec_color = {
           #------------ target ------------
           "cloth0": self.path
            + "/Assets/Garment/Trousers/Long/PL_075/PL_075_obj.usd",    # black trousers
           # ----------- blue ------------
            ...
            + "/Assets/Garment/Tops/Collar_Lsleeve_FrontClose/TCLC_Top583/TCLC_Top583_obj.usd", # blue tops
            "cloth2": self.path
            + "/Assets/Garment/Trousers/Long/PL_047/PL_047_obj.usd",    # blue trousers
            "cloth3": self.path
            + "/Assets/Garment/Trousers/Long/PL_M1_094/PL_M1_094_obj.usd",       # blue trousers
            # ----------- red ------------
            "cloth4": self.path
            + "/Assets/Garment/Dress/Long_ShortSleeve/DLSS_Dress172/DLSS_Dress172_obj.usd", # red dress
            "cloth5": self.path
            + "/Assets/Garment/Tops/Collar_Lsleeve_FrontClose/TCLC_Top107/TCLC_Top107_obj.usd", # red tops
            "cloth6": self.path
            + "/Assets/Garment/Trousers/Long/PL_Pants081/PL_Pants081_obj.usd",    # red trousers
            "cloth7": self.path
            + "/Assets/Garment/Trousers/Short/PS_M1_040/PS_M1_040_obj.usd",  # red trousers
            "cloth8": self.path
            + "/Assets/Garment/Glove/GL_Gloves108/GL_Gloves108_obj.usd",  # red gloves
            "cloth9": self.path
            + "/Assets/Garment/Hat/HA_Hat015/HA_Hat015_obj.usd",    # red hat
            # ----------- pink ------------
            "cloth10": self.path
            + "/Assets/Garment/Dress/Short_LongSleeve/DSLS_Dress207/DSLS_Dress207_obj.usd", # pink dress
            "cloth11": self.path
            + "/Assets/Garment/Trousers/Long/PL_Pants095/PL_Pants095_obj.usd",      # pink trousers
            "cloth12": self.path
            + "/Assets/Garment/Hat/HA_hat104/HA_hat104_obj.usd",    # pink hat
            # ----------- black ------------
            "cloth13": self.path
            ...
            + "/Assets/Garment/Tops/Hooded_Lsleeve_FrontOpen/THLO_Jacket107/THLO_Jacket107_obj.usd",    # cyan tops
            "cloth27": self.path
            + "/Assets/Garment/Trousers/Long/PL_Pants055/PL_Pants055_obj.usd",    # cyan trousers
            # ----------- brown ------------
            "cloth28": self.path
            + "/Assets/Garment/Trousers/Long/PL_M1_030/PL_M1_030_obj.usd",       # brown trousers
            "cloth29": self.path
            + "/Assets/Garment/Hat/HA_Hat018/HA_Hat018_obj.usd",     # brown hat
            # ----------- gray ------------
            "cloth30": self.path
            + "/Assets/Garment/Glove/GL_Gloves039/GL_Gloves039_obj.usd",  # gray gloves
        }
