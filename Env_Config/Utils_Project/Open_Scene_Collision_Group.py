...
class Collision_Group:
    def __init__(self, stage):
        ...
        self.collectionAPI_fence.CreateIncludesRel().AddTarget("/World/Table/Cube")
        self.collectionAPI_helper.CreateIncludesRel().AddTarget("/World/Table/node_d_model")
        self.collectionAPI_helper.CreateIncludesRel().AddTarget("/World/Basket")
        ...
        )  # Franka can't collide with rigid

        self.filter_attach.AddTarget(
            self.rigid_group_path
        )  # Attach Object can't collide with rigid
        self.filter_attach.AddTarget(
            self.garment_group_path
